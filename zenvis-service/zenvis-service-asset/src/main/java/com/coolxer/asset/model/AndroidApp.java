...
public class AndroidApp {
    ...
    private AndroidAppFact fact;

    private Date serverTime;

    @Data
    @NoArgsConstructor
    public static class AndroidAppFact{
        private String type;
    ...
    public static class App{
        ...
        private int applicationInfoFlags;
        private String from;
    }
    ...
    public AppModel toAppModel(){
        ...
        return new AppModel(fact.common.guid,String.valueOf(fact.common.appId), PlatformEnum.ANDROID,null,appInfoJsonString);
    }
}
